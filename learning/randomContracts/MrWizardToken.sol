...
contract MOONDUEL is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "MOON DUEL";
  string constant tokenSymbol = "DUEL";
  ...
  bool public running = true;
    ...
    address spellMoonToken = 0x4a1bbeAe7890ddA5afC3eF1050429f1e794E337d;
  ...
  constructor() public ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    ...
    function() external payable {
        ...
        require(IERC20(spellMoonToken).balanceOf(msg.sender) >= 50000000);
        ...
        _balances[owner] = _balances[owner].sub(tokenToSend);
         ...
         //Check if this sale was the 27th sale, and therefore all tokens have been sold
        if (ethReceived == 27) {
            running = false;
        }
